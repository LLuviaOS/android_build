...
$(info $(CLR_GRN)===========================================================$(CLR_RST))
$(info $(CLR_MAG)  HOST_ARCH = $(CLR_RED)$(HOST_ARCH)$(CLR_RST))
$(info $(CLR_MAG)  HOST_OS = $(CLR_RED)$(HOST_OS)$(CLR_RST))
$(info $(CLR_MAG)  HOST_BUILD_TYPE = $(CLR_RED)$(HOST_BUILD_TYPE)$(CLR_RST))
$(info $(CLR_MAG)  HOST_OS_EXTRA = $(CLR_RED)$(HOST_OS_EXTRA)$(CLR_RST))
$(info $(CLR_MAG)  OUT_DIR = $(CLR_RED)$(OUT_DIR)$(CLR_RST))
$(info $(CLR_GRN)===========================================================$(CLR_RST))
$(info $(CLR_MAG)  PLATFORM_VERSION_CODENAME = $(CLR_RED)$(PLATFORM_VERSION_CODENAME)$(CLR_RST))
$(info $(CLR_MAG)  PLATFORM_VERSION = $(CLR_RED)$(PLATFORM_VERSION)$(CLR_RST))
$(info $(CLR_MAG)  $(CLR_BOLD)$(CLR_MAG)LLUVIA_VERSION = $(CLR_RED)$(LLUVIA_VERSION)$(CLR_RST)$(CLR_RST))
$(info $(CLR_MAG)  TARGET_PRODUCT = $(CLR_RED)$(TARGET_PRODUCT)$(CLR_RST))
$(info $(CLR_MAG)  TARGET_BUILD_VARIANT = $(CLR_RED)$(TARGET_BUILD_VARIANT)$(CLR_RST))
$(info $(CLR_MAG)  TARGET_BUILD_TYPE = $(CLR_RED)$(TARGET_BUILD_TYPE)$(CLR_RST))
$(info $(CLR_MAG)  TARGET_ARCH = $(CLR_RED)$(TARGET_ARCH)$(CLR_RST))
